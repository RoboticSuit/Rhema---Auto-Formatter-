# Source Trace:
# File: formatter_v0.2.py
# Knowledge Files: CodeSourceDB v3.6, SyntaxBiasDB v2.3, HumanSyntaxDB v1.2, mainProtocol v5.5
# REF_IDs: RM_DO178_001, RM_ISO_001, RM_HCI_002, WEB_PY_001, WEB_PY_004, WEB_PY_009
...
#        v0.2 -- imports NUMBERED_HEADING_RE as public name (WEB_PY_004 fix 8).
...
def _split_heading_from_body(text: str):
    ...
    """
    from core.detector import NUMBERED_HEADING_RE
