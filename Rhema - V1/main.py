...
# ---------------------------------------------------------------------------
# Mode placeholders -- replaced as each mode module is completed.
# Each placeholder prints a clear "not yet available" message so the
# menu is fully navigable before the pipeline is built.
# REF_ID: RM_HCI_002
# ---------------------------------------------------------------------------
...
def _route(option: str) -> None:
    ...
    Unrecognised options are treated as a no-op -- the menu loop
    guards against invalid input before reaching here.
    REF_ID: RM_DO178_001
    """
...
if __name__ == "__main__":
    try:
        ...
        # Catch-all safety net -- surfaces unexpected errors without
        # exposing a stack trace to the non-technical user.
        # Diagnostic detail goes to stderr per POSIX.1-2017.
        # REF_ID: RM_HCI_004
        import traceback
