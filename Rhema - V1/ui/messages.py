...
from config.constants import APP_NAME, APP_VERSION, APP_TAGLINE, LIBRARY_DISPLAY_WIDTH
...
PREVIEW_PROMPT: str = (
    "\nIs this correct?\n"
    "Type 'yes' to continue, or describe what needs to change.\n"
...
PREVIEW_RECONFIRM_PROMPT: str = (
    "Is this correct now? Type 'yes' to continue or describe another change.\n"
    "Type 'cancel' to skip this file."
)
...
def msg_library_entry(index: int, display_name: str, saved_date: str) -> str:
    name_col: str = display_name.ljust(30)
